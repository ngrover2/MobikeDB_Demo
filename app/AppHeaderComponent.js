	...
	return(
		<Grid horizontal={"true"} columns={16} style={headerStyle}>
			<GridRow style={{alignItems:"center"}}>
				...
				<GridColumn width={4}>
					<HeaderLinkButton to={`/storedprocs/findbikes`} name="Bikes" style={buttonStyle}/>
				</GridColumn>
				<GridColumn width={4}>
					<HeaderLinkButton to={`/storedprocs/rides`} name="Rides"/>
				</GridColumn>
				<GridColumn width={3}>
					<HeaderLinkButton to="/duh" name="Prices"/>
				</GridColumn>
				<GridColumn width={3}>
					<HeaderLinkButton to="/duh" name="Plans"/>
				</GridColumn>
			</GridRow>
		</Grid>
	);
